...
│   │   │   ├── components/      ← Cronómetro, Marcador, LetterBoard, NumberBoard, StepsList, ChoicePicker, OpponentPicker, InviteLink
...
- **Hosting del servidor Socket.IO** para el modo online (Render/Fly.io/Railway u otro) — decidir en el momento del despliegue, no bloquea el desarrollo local.
- **Tamaño del diccionario (~7,9MB):** funciona bien tras el primer precacheo del service worker, pero el primer download es pesado para móvil — ver Fase 2 del backlog.
